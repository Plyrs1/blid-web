...
<div
	class="flex flex-col backdrop-blur-md bg-black/20 rounded-lg overflow-hidden hover:outline hover:outline-4 hover:outline-white hover:outline-offset-2"
>
	<div class="bg-center w-full h-32" style="background-image:url('{imgUrl}')">
		<div
			class="grid grid-flow-row md:grid-flow-col justify-end align-bottom content-end gap-1 p-1 w-full h-full overflow-hidden bg-black/40"
		>
			<div
				class="px-2 py-[1px] border-[1px] h-min border-white rounded-md text-white text-sm hover:bg-black/40"
			>
				$ 100.000
			</div>
			<div
